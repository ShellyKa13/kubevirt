...
func (u *updater) updateUnstructured(obj runtime.Object) (oldStatus interface{}, newStatus interface{}, err error) {
	...
	switch obj.(type) {
	case *backupv1.VirtualMachineBackup:
		oldObj := obj.(*backupv1.VirtualMachineBackup)
		newObj, err := u.cli.VirtualMachineBackup(a.GetNamespace()).Update(context.Background(), oldObj, metav1.UpdateOptions{})
		if err != nil {
			return nil, nil, err
		}
...
func (u *updater) updateStatusUnstructured(obj runtime.Object) (err error) {
	...
	case *backupv1.VirtualMachineBackup:
		oldObj := obj.(*backupv1.VirtualMachineBackup)
		_, err = u.cli.VirtualMachineBackup(oldObj.Namespace).UpdateStatus(context.Background(), oldObj, metav1.UpdateOptions{})
	case *exportv1.VirtualMachineExport:
		oldObj := obj.(*exportv1.VirtualMachineExport)
