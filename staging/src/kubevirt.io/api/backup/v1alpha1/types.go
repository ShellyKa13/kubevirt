...
const (
	// BackupAbortUndefined defines a nil abort status
	BackupAbortUndefined BackupAbortStatus = "Undefined"
	// BackupAbortSucceeded means that the VirtualMachineInstance backup has been aborted
	BackupAbortSucceeded BackupAbortStatus = "AbortSucceeded"
	// BackupAbortFailed means that the vmi backup has failed to be abort
	BackupAbortFailed BackupAbortStatus = "AbortFailed"
	// BackupAbortInProgress mean that the vmi backup is aborting
	BackupAbortInProgress BackupAbortStatus = "AbortInProgress"
)
